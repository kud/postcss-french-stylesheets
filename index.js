...
module.exports = postcss.plugin('postcss-french-stylesheets', function (opts) {
    opts = opts || {};
    ...
    return function (css) {
        css.walkDecls(function transformDecl(decl) {
            ...
            decl.prop = decl.prop.replace('flux', 'float');
            ...
            decl.prop = decl.prop.replace('approche', 'letter-spacing');
